...
#ifndef _NDS_SHOP_THEME_HPP
#define _NDS_SHOP_THEME_HPP
...
class Theme {
public:
	Theme(const std::string &ThemeJSON = "sdmc:/3ds/Universal-Updater/NDS-Shop/themes/Themes.json");
	nlohmann::json InitWithDefaultColors(const std::string &ThemePath = "sdmc:/3ds/Universal-Updater/NDS-Shop/themes/Themes.json");
